...
<body>
    ...
    <div class="container" id="billContainer">
        <div class="row">
            <div class="display-3 pt-3 ml-3">Bill</div>
        </div>
        <hr>
        <div class="row p-1">
        ...
        <button onclick="javascript:printDiv('billContainer')" class="btn btn-primary p-2 m-1">Print this bill</button><br>
            <a href="home" class="btn btn-primary p-2 m-1">Cancel</a>
            <a href="PaymentPage.html" class="btn btn-primary p-2 m-1">Proceed</a><br><br>
        </div>
    </div>
